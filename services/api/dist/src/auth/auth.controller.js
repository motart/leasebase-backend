...
const auth_config_dto_1 = require("./dto/auth-config.dto");
...
__decorate([
    (0, common_1.Get)('me'),
    (0, swagger_1.ApiOperation)({ summary: 'Get current authenticated user info from Cognito token' }),
    ...
    __metadata("design:returntype", current_user_dto_1.CurrentUserDto)
], AuthController.prototype, "me", null);
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Get)('config'),
    (0, swagger_1.ApiOperation)({ summary: 'Get public Cognito configuration used by this API' }),
    (0, swagger_1.ApiOkResponse)({ type: auth_config_dto_1.AuthConfigDto }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", auth_config_dto_1.AuthConfigDto)
